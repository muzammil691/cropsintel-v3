-- Atlas Schema Complete Migration
-- Phase 1.10b2 — Full Atlas database substrate
-- Created: 2026-05-07 12:00:00 UTC
--
-- This migration creates all Atlas tables, views, and RLS policies:
-- - 5 tables: conversations, snapshots, dispatches, decisions, cost_log
-- - 2 aggregate views: cost_today, cost_month_to_date
...
-- ============================================================================
-- VIEW: atlas_cost_today
-- Aggregate cost and token usage for current day (UTC)
-- ============================================================================
...
-- ============================================================================
-- VIEW: atlas_cost_month_to_date
-- Aggregate cost and token usage for current month (UTC)
-- ============================================================================
...
-- ============================================================================
-- RLS POLICIES
-- Admin-only access to all Atlas tables
-- ============================================================================
