...
### Gap 1: files-exist
- Severity: `fail`
- Expected: verifier/src/checks/__tests__/stub-detector.test.ts exists
- Actual: verifier/src/checks/__tests__/stub-detector.test.ts is missing
- Remediation: Create verifier/src/checks/__tests__/stub-detector.test.ts per task spec

### Gap 2: tests-exist
- Severity: `fail`
- Expected: Test file verifier/src/checks/__tests__/stub-detector.test.ts exists
- Actual: verifier/src/checks/__tests__/stub-detector.test.ts is missing
- Remediation: Create verifier/src/checks/__tests__/stub-detector.test.ts with test cases for the feature
