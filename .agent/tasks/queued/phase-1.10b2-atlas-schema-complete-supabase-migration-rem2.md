...
- Actual: Unhandled exception: ENOENT: no such file or directory, open '/workspace/cropsintel-v3/.agent/tasks/queued/phase-1.10b2-atlas-schema-complete-supabase-migration-rem.md'
